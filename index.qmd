...
# Styling
ax.set_xlabel('Time Period (Years)', fontsize=8)
ax.set_ylabel('Account Balance ($)', fontsize=8)
ax.set_title('Account Balance Over Time: Single Simulation Run', fontsize=10, fontweight='bold')
